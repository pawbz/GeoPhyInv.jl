...
real, dimension(mesh_nz,mesh_nx), intent(in)            :: modtt, modrr
...
lambda = extend(modtt**(-rone_de), mesh_na_pml, mesh_nx, mesh_nz)
rho = extend(modrr**(-rone_de), mesh_na_pml, mesh_nx, mesh_nz)
