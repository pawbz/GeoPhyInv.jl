...
function fdtd_mod(;
		  ...
		  npropwav::Int64 = 1, 
		  mgrid::Grid.Mod2D = Grid.Mod2D(), 
		  model::Models.Seismic = Models.Seismic("test_homo_acoustic", mgrid),
...
#        return
	...
	recv_out = zeros(tgrid.nt*acqgeom.nr*acqgeom.ns)
...
return reshape(recv_out,(tgrid.nt,acqgeom.nr,acqgeom.ns))
end
