...
function PFdtd(
    ...
    @timeit to "alloc field arrays" begin
    ...
    @timeit to "alloc pml arrays" begin
        # PML
        pml = get_pml(attrib_mod, exmedium.grid)
    end

    @timeit to "alloc gradient arrays" begin
    ...
    @timeit to "alloc misc arrays" begin
    ...
    @timeit to "alloc data arrays" begin
    ...
    @timeit to "alloc P_common" begin
        pac = P_common(
            jobname,
            attrib_mod,
            exmedium,
    ...
    @timeit to "alloc P_x_worker" begin
        ...
        papa = ddata(
            ...
            pids=work[1:nworker], # disable distributed in order for Pluto to work (waiting for Pluto bug to enable distributed)
        )
    end
...
function P_x_worker_x_pw(ipw, sschunks::UnitRange{Int64}, pac::P_common{T,N}) where {T,N}
    ...
    @timeit to "alloc w1 field arrays" begin
        w1 = NamedArray(
    ...
    @timeit to "alloc derivative field for pml" begin
...
function P_x_worker_x_pw_x_ss(ipw, iss::Int64, pac::P_common{T,N}) where {T,N}
    ...
    @timeit to "alloc wavelets" begin
        # source wavelets
        wavelets = [
            NamedArray(
    ...
    @timeit to "alloc boundary" begin
    ...
    @timeit to "alloc gradients" begin
    ...
    @timeit to "update pass acq" begin
        # update acquisition
