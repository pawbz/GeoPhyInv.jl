...
sayhelloin = "Julia"
sayhelloout = "Jua"
ccall( (:sprint, SeismicInversion.F90libs.test), Void, (Ptr{UInt8},Ptr{UInt8}), sayhelloin, sayhelloout )
println(sayhelloout)
...
ccall( (:real64_in_out, SeismicInversion.F90libs.test), Void, (Ptr{Float64},Ptr{Float64}), kin, k)
@test_approx_eq k kin 

ccall( (:int64_in_out, SeismicInversion.F90libs.test), Void, (Ref{Int64},Ref{Int64}), n1in, n1)
n1 = n1[1]
